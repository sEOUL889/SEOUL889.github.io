...
footer.href = "https://www.instagram.com/setiawanheru22/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayangkuuuuuuuu", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} MAU BILANG Makasih yaa :3 ${nama}`).then(function () {
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('Jahat banget emang ga kangen sama ABIII', '', 'error').then(function () {
